...
API_KEY = "MlWWCAuGawki3VQpdBMnjEch5PdnyQxTVyAHcQWg9zXp"
...
def predict():
  ...
  response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/80e1ead3-3e72-43f9-bb4a-982d4df02e56/predictions?version=2022-10-15', json=payload_scoring,
